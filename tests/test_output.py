...
class OutputTests(unittest.TestCase):
    ...
    def test_enabled_characters_table_contains_expandable_spec_details(self):
        ...
        self.assertIn('data-professions-target="professions-0"', html)
        self.assertIn('>Professions</button>', html)
        ...
        self.assertIn('<template id="professions-0">', html)
        self.assertNotIn('<div class="detail-title detail-title-spaced">Expansion Skill Levels</div>', html)
    ...
    def test_account_summary_last_update_is_quiet_local_time(self):
        ...
        self.assertIn("bindExpandableRows", html)
